...
inline HRESULT Engine::Ready_Buffer(LPDIRECT3DDEVICE9 pGraphicDev, const _ushort& wContainerIdx, CVIBuffer::BUFFERTYPE eBufferType, const TCHAR* pResourceKey, const _ulong& wCntX/* = 0*/, const _ulong& wCntZ/* = 0*/, const _ulong& wItv/* = 1*/, vector<_vec3>* pVecPos/* = NULL*/)
{
	return Engine::CResourceMgr::GetInstance()->Ready_Buffer(pGraphicDev, wContainerIdx, eBufferType, pResourceKey, wCntX, wCntZ, wItv, pVecPos);	
}
