...
CSkillBar::CSkillBar(LPDIRECT3DDEVICE9 pGraphicDev)
...
CSkillBar::~CSkillBar(void)
{

}

HRESULT CSkillBar::Initialize(void)
{
...
HRESULT CSkillBar::Add_Component(void)
{
	...
	pComponent = m_pTextureCom = (Engine::CTexture*)Engine::Clone_Resource(RESOURCE_STAGE, L"Texture_SkillBar");
	if(NULL == pComponent)
		return E_FAIL;
...
_int CSkillBar::Update(const _float& fTimeDelta)
{
...
CSkillBar* CSkillBar::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CSkillBar*		pGameObject = new CSkillBar(pGraphicDev);
...
void CSkillBar::Set_ContantTable(void)
{
