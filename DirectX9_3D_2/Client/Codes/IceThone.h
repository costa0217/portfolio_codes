...
class CIceThone	: public Engine::CGameObject
{
private:
	explicit CIceThone(LPDIRECT3DDEVICE9 pGraphicDev, int iIdx);
	virtual ~CIceThone(void);
...
public:
	static CIceThone* Create(LPDIRECT3DDEVICE9 pGraphicDev, int iIdx);
