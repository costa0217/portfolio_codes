...
HRESULT Engine::CResourceMgr::Ready_Buffer(LPDIRECT3DDEVICE9 pGraphicDev
										...
										, const _ulong& wCntX /*= 0*/
										, const _ulong& wCntZ /*= 0*/
										, const _ulong& wItv /*= 1*/
										, vector<_vec3>* pVecPos /*= NULL*/)
{
	...
	case CVIBuffer::TYPE_TERRAIN:
		pBuffer = CTerrainTex::Create(pGraphicDev, wCntX, wCntZ, wItv, pVecPos);
		break;

	case CVIBuffer::TYPE_TRAIL:
		pBuffer = CTrailTex::Create(pGraphicDev);
		break;
	}
