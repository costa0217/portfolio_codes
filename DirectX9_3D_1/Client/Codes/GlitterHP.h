#ifndef GlitterHP_h__
#define GlitterHP_h__
...
class CMonster;
class CGlitterHP : public Engine::CGameObject
{
	DECLARE_SINGLETON(CGlitterHP)
private:
	explicit CGlitterHP(void);
	virtual ~CGlitterHP(void);
