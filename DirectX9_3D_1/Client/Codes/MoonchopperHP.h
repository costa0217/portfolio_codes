#ifndef MoonchopperHP_h__
#define MoonchopperHP_h__
...
class CMonster;
class CMoonchopperHP : public Engine::CGameObject
{
	DECLARE_SINGLETON(CMoonchopperHP)
private:
	explicit CMoonchopperHP(void);
	virtual ~CMoonchopperHP(void);
