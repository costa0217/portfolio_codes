...
inline HRESULT Engine::Ready_Texture(LPDIRECT3DDEVICE9 pGraphicDev, const _ushort& wContainerIdx, CTexture::TEXTURETYPE eTextureType, const TCHAR* pResourceKey, const TCHAR* pFilePath, const _ushort& wCnt/* = 1*/)
{
	return Engine::CResourceMgr::GetInstance()->Ready_Texture(pGraphicDev, wContainerIdx, eTextureType, pResourceKey, pFilePath, wCnt);
}
inline HRESULT Engine::Ready_Mesh(LPDIRECT3DDEVICE9 pGraphicDev, const _ushort& wContainerIdx, CMesh::MESHTYPE eMeshType, const TCHAR* pMeshKey, const TCHAR* pFilePath, const TCHAR* pFileName)
{
	return Engine::CResourceMgr::GetInstance()->Ready_Mesh(pGraphicDev, wContainerIdx, eMeshType, pMeshKey, pFilePath, pFileName);
}
...
{
	return Engine::CResourceMgr::GetInstance()->Delete_Resource(wContainerIdx, pResourceKey);
}
