 ...
 *
 * \brief Engine_Macro 헤더파일
 *
 * TODO: 엔진에서 사용하는 메크로들을 모아 놓은 헤더 파일
 *
 * \note
*/
...
#define MSG_BOX(_message) MessageBox(NULL, TEXT(_message), TEXT("System Message"), MB_OK | MB_ICONEXCLAMATION)
