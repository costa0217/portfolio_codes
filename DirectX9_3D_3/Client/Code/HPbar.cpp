...
HRESULT CHPBar::Initialize(void)
{
	...
	m_pInfo->m_vPos		= D3DXVECTOR3(0.f, -0.8f, 0.f);
	m_pInfo->m_vScale	= D3DXVECTOR3(0.272f, 0.073f, 1.f);
...
{
	CHPBar* pObj = new CHPBar(pDevice);
...
HRESULT CHPBar::AddComponent(void)
{
	...
	//((Engine::CTransform*)pComponent)->SetScale(D3DXVECTOR3(0.47f, 0.09f,1.f));
...
void CHPBar::TransformMatrix(void)
{
...
void CHPBar::SetPos(const D3DXVECTOR3& rPos)
{
	m_pInfo->m_vPos = rPos;
}
