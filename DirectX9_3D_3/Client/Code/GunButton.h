...
#ifndef GunButton_h__
#define GunButton_h__
...
{
private:
	explicit CGunButton(LPDIRECT3DDEVICE9 pDevice);

public:
	virtual ~CGunButton(void);
...
public:
	static CGunButton* Create(LPDIRECT3DDEVICE9 pDevice);
