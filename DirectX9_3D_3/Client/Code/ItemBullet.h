#ifndef ItemBullet_h__
#define ItemBullet_h__
...
{
private:
	explicit CItemBullet(LPDIRECT3DDEVICE9 pDevice);

public:
	virtual ~CItemBullet(void);
...
public:
	static CItemBullet* Create(LPDIRECT3DDEVICE9 pDevice);
...
private:
	float		 m_fPlayerBullet;
	D3DXVECTOR3  m_vPlayerPos;

};
#endif // ItemBullet_h__
