...
CMist::CMist(LPDIRECT3DDEVICE9 pDevice)
:CEffect(pDevice)
{
...
CMist* CMist::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CMist* pObj = new CMist(pDevice);
...
HRESULT CMist::AddComponent(void)
{
	...
	//Texture
	pComponent = m_pResourceMgr->CloneResource(Engine::RESOURCE_DYNAMIC, L"Texture_Mist");
