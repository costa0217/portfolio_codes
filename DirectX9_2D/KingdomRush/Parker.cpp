...
HRESULT CParker::Initialize(void)
{
	m_pSoldier		= NULL;
	...
	m_tStats		= UNITSTATS(L"Parker", 400, 1, 20, 20); //이름, 체력, 최소댐, 최대댐, 이동속도
	m_iGold			= rand()%10 + 50;
	m_fMaxHP		= (float)m_tStats.iHP;
	m_wstrObjKey	= L"Parker";
